...
public class MenuLista {
    ...
    private Usuario usuarioAtivo; // Assumindo que você terá um usuário logado
    ...
    private void incluirLista() {
        ...
        System.out.print("Data limite (DD/MM/AAAA, deixe em branco se não houver): ");
        String dataLimiteStr = console.nextLine();
        LocalDate dataLimite = null;
        if (!dataLimiteStr.isEmpty()) {
            // Implemente a lógica para converter a string para LocalDate
            // Por simplicidade, vamos usar null por enquanto
            System.out.println("Data limite não implementada. Usando null.");
        }
        
        // Gere um código compartilhável (NanoID)
    ...
    // Método para gerar um NanoID de 10 caracteres
